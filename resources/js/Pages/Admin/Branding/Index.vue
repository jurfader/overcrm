...
<template>
    ...
    <div class="p-6 space-y-6 animate-fade-in">
        ...
        <div class="flex items-center justify-between gap-4 flex-wrap">
            <div>
                <h1 class="text-2xl font-bold gradient-brand-text">Branding</h1>
                <p class="text-sm text-foreground-muted mt-0.5">Dostosuj kolory, logo i nazwy systemu do swojej marki</p>
            </div>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-[1fr_minmax(360px,420px)] gap-6">
            <!-- FORM -->
            <div class="space-y-6">
                <!-- Nazwy -->
                <section class="glass-card rounded-lg p-6 space-y-4">
                    <div>
                        <h2 class="text-lg font-semibold text-foreground">Nazwy</h2>
                ...
                <section class="glass-card rounded-lg p-6 space-y-4">
                    <div class="flex items-center justify-between gap-3 flex-wrap">
                        <div>
                            <h2 class="text-lg font-semibold text-foreground">Kolory marki</h2>
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="flex items-center gap-2">
                                <input type="color" v-model="form.primary_color"
                                       class="w-12 h-9 rounded border border-border-bright cursor-pointer bg-surface-elevated" />
                ...
                <section class="glass-card rounded-lg p-6 space-y-4">
                    <div>
                        <h2 class="text-lg font-semibold text-foreground">Motyw domyślny</h2>
                        ...
                        <button type="button" @click="form.default_theme = 'dark'"
                                :class="['rounded-lg border-2 p-4 text-left transition-all',
                                          form.default_theme === 'dark'
                                              ? 'border-brand-primary surface-elevated'
                ...
                <section class="glass-card rounded-lg p-6 space-y-4">
                    <div>
                        <h2 class="text-lg font-semibold text-foreground">Logo i favicon</h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div v-for="asset in [
                                { key: 'logo_url',      label: 'Logo (motyw jasny)', accept: 'image/png,image/svg+xml,image/webp,image/jpeg', bg: 'surface-elevated' },
                                { key: 'logo_dark_url', label: 'Logo (motyw ciemny)', accept: 'image/png,image/svg+xml,image/webp,image/jpeg', bg: 'bg-[#0B0B14]' },
                                { key: 'favicon_url',   label: 'Favicon', accept: 'image/x-icon,image/png,image/svg+xml', bg: 'surface-elevated' },
                ...
                <section class="glass-card rounded-lg p-6 space-y-4">
                    <div>
                        <h2 class="text-lg font-semibold text-foreground">Kontakt support</h2>
            ...
            <!-- LIVE PREVIEW -->
            <aside class="self-start sticky top-[calc(var(--topbar-height)+1.5rem)]">
                <div class="glass-card rounded-lg overflow-hidden">
                    ...
                    <div class="p-5 space-y-5">
                        ...
                        <!-- Sample tile -->
                        <div class="surface-elevated rounded-lg p-4 flex items-center gap-3">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex gap-2 flex-wrap">
                                ...
                                <button class="px-4 py-2 rounded-lg text-sm font-medium border border-border-bright surface-elevated text-foreground">
                                    Akcja drugorzędna
                                </button>
                            </div>
                        </div>
