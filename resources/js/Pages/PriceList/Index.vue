...
<template>
    ...
    <div class="max-w-3xl mx-auto space-y-8">
        <div>
            <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Cenniki</h1>
        ...
        <div
            ...
            class="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-8 text-center text-slate-500 dark:text-slate-400"
        >
        ...
        <div v-else class="grid gap-4 sm:grid-cols-2">
            <a
                ...
                target="_blank"
                rel="noopener"
                class="group relative flex flex-col rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-6 hover:border-amber-400 dark:hover:border-amber-500 transition-colors"
            >
                <div class="flex items-start justify-between gap-3">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h2 class="font-semibold text-slate-900 dark:text-white group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors">
                                {{ pl.name }}
                            </h2>
                            <p v-if="pl.description" class="text-sm text-slate-500 dark:text-slate-400 mt-0.5">
                                {{ pl.description }}
                            </p>
                        </div>
                    </div>
