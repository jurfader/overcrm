...
const navAdmin = [
    ...
    { name: 'Marketplace',     route: 'admin.marketplace.index',      icon: 'puzzle',        pattern: 'admin.marketplace.*',      roles: ['admin'] },
    { name: 'Moduły (admin)',  route: 'admin.modules.index',          icon: 'settings',      pattern: 'admin.modules.*',          roles: ['admin'] },
