...
class ClientController extends Controller
{
    ...
    private function profileValidationRules(): array
    {
        return [
            ...
            'profile.chicken' => 'nullable|array',
            'profile.chicken.serves_chicken' => 'nullable|boolean',
            'profile.chicken.serving_form' => 'nullable|string|max:255',
            'profile.chicken.volume' => 'nullable|string|max:100',
